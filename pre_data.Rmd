...
```{r,eval=FALSE}
save(minke,file='minke.Rdata')
```

where R saves the minke data frame to a file called 'minke.Rdata'. You can any number of objects to a file:

```{r,eval=FALSE}
save(minke,length, weight, file = 'someData.Rdata')
```
...
for more db stuff refer to the help page for `db_list_tables`
