...
x1 <- 1 + 1           # save the result of a calculation as an object
x2 <- 1 - 1
...
x <- c(1:10)
x[9]                 # get the first element of a vector
x[c(1, 10)]           # get the first and second element
...
ls(3)             # what objects are in the second environment*
...
setwd("../")  # assumes you have a directory names "img"
