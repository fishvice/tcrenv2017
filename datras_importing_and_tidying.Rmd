...
ns_area <- rgdal::readOGR("/home/haf/einarhj/prj2/bookdown/datrasdoodle/data-raw/NS_IBTS_RF.dbf", verbose = FALSE)
...
sp <- read_csv("/home/haf/einarhj/prj2/bookdown/datrasdoodle/data-raw/SPCODE.csv")
...
```{r, eval = FALSE}
save(st, le, ag, file = "data/nsibts_tidy.rda")
```
