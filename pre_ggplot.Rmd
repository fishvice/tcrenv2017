...
It is sometimes useful to plot the "raw" data over summary plots. Using `geom_point` as an overlay of the above plot (left) is not very useful, `geom_jitter` coming to the rescue (right):
```{r, out.width = "50%", fig.show = "hold"}
